	...
	private class RoomInfoDataDownloadingTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPostExecute(String jsonString) {
			...
			try {
				...
				mRoomInfoModelController = new RoomInfoModelController();
				mRoomInfoModelController.setPen_id(roomInfoList.optInt("pen_id"));
				mRoomInfoModelController.setRoom_name(roomInfoList.optString("room_name"));
				mRoomInfoModelController.setPen_period_division(roomInfoList.optString("pen_period_division"));
				mRoomInfoModelController.setPeriod_start(roomInfoList.optString("period_start"));
				mRoomInfoModelController.setPeriod_end(roomInfoList.optString("period_end"));
				mRoomInfoModelController.setWeekdays(roomInfoList.optInt("weekdays"));
				mRoomInfoModelController.setFriday(roomInfoList.optInt("friday"));
				mRoomInfoModelController.setWeekends(roomInfoList.optInt("weekends"));
				mRoomInfoModelController.setRoom_std_people(roomInfoList.optInt("room_std_people"));
				mRoomInfoModelController.setRoom_max_people(roomInfoList.optInt("room_max_people"));
				mRoomInfoModelController.setRoom_pyeong(roomInfoList.optInt("room_pyeong"));
				mRoomInfoModelController.setNum_rooms(roomInfoList.optInt("num_rooms"));
				mRoomInfoModelController.setNum_toilets(roomInfoList.optInt("num_toilets"));
				mRoomInfoModelController.setRoom_aircon(roomInfoList.optInt("room_aircon"));
				mRoomInfoModelController.setRoom_equipment(roomInfoList.optString("room_equipment"));
				mRoomInfoModelController.setRoom_description(roomInfoList.optString("room_description"));
				mRoomInfoModelController.setPen_region(roomInfoList.optString("pen_region"));
				mRoomInfoModelController.setPen_name(roomInfoList.optString("pen_name"));
				mRoomInfoModelController.setPen_homepage(roomInfoList.optString("pen_homepage"));
				mRoomInfoModelController.setPen_lot_adr(roomInfoList.optString("pen_lot_adr"));
				mRoomInfoModelController.setPen_road_adr(roomInfoList.optString("pen_road_adr"));
				mRoomInfoModelController.setPen_latitude(roomInfoList.optDouble("pen_latitude"));
				mRoomInfoModelController.setPen_longitude(roomInfoList.optDouble("pen_longitude"));
				mRoomInfoModelController.setPen_ceo(roomInfoList.optString("pen_ceo"));
				mRoomInfoModelController.setPen_phone1(roomInfoList.optString("pen_phone1"));
				mRoomInfoModelController.setPen_phone2(roomInfoList.optString("pen_phone2"));
				mRoomInfoModelController.setPen_checkin(roomInfoList.optString("pen_checkin"));
				mRoomInfoModelController.setPen_checkout(roomInfoList.optString("pen_checkout"));
				mRoomInfoModelController.setPen_check_caution(roomInfoList.optString("pen_check_caution"));
				mRoomInfoModelController.setPen_pickup(roomInfoList.optInt("pen_pickup"));
				mRoomInfoModelController.setPen_pickup_description(roomInfoList.optString("pen_pickup_description"));
				mRoomInfoModelController.setPen_barbecue(roomInfoList.optInt("pen_barbecue"));
				mRoomInfoModelController.setPen_barbecue_description(roomInfoList.optString("pen_barbecue_description"));
				mRoomInfoModelController.setPen_ground(roomInfoList.optInt("pen_ground"));
				mRoomInfoModelController.setPen_ground_description(roomInfoList.optString("pen_ground_description"));
				mRoomInfoModelController.setPen_valley(roomInfoList.optInt("pen_valley"));
				mRoomInfoModelController.setPen_valley_description(roomInfoList.optString("pen_valley_description"));
				mRoomInfoModelController.setPen_etc_facility(roomInfoList.optString("pen_etc_facility"));
				mRoomInfoModelController.setPen_caution(roomInfoList.optString("pen_caution"));
				mRoomInfoModelController.setPen_cost_caution(roomInfoList.optString("pen_cost_caution"));
				mRoomInfoModelController.setPen_walk_station(roomInfoList.optString("pen_walk_station"));
				mRoomInfoModelController.setPen_walk_terminal(roomInfoList.optString("pen_walk_terminal"));
				mRoomInfoModelController.setPen_picture_flag(roomInfoList.optInt("pen_picture_flag"));
				mRoomInfoModelController.setCost_table(roomInfoList.optJSONArray("cost_table"));
				mRoomInfoModelController.setPeriod_table(roomInfoList.optJSONArray("period_table"));
				mRoomInfoModelController.setRoom_cost(roomInfoList.optInt("room_cost"));
				// end of the setting

				mOnResultFragmentListener.onLoadSpecificInfoFragment(mRoomInfoModelController, roomArray);
